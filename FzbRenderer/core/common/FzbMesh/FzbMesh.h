...
public:
	...
	FzbMesh(FzbVertexFormat vertexFormat = FzbVertexFormat());
...
struct FzbMeshDynamic : public FzbMesh {
	glm::mat4 transforms = glm::mat4(1.0f);	//变换矩阵
	FzbBuffer meshBuffer;

	inline static VkDescriptorSetLayout meshDescriptorSetLayout = nullptr;
