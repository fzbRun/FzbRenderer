...
VkPipelineLayout fzbCreatePipelineLayout(std::vector<VkDescriptorSetLayout>* descriptorSetLayout) {
	...
	if (vkCreatePipelineLayout(FzbRenderer::globalData.logicalDevice, &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS) {
